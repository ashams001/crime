...
<body background="images/login1.jpg" style="background-size: 100%;background-repeat: no-repeat;">
...
<div style="background-color: #ffffff; border-radius: 3px;border-bottom: 3px solid #116ab9; padding-top:5px; padding-left: 6px; position: absolute; width:100%;top:0px;">
  <img src='images/police.jfif'style="float: left;padding: 10px 18px;width:80px; height:80px;"/><center><p style="letter-spacing: 3px;color: #454a4b;font-size:30px;padding-top:20px;">Crime Record Management System </p></center>
</div>
<br><br><br>
